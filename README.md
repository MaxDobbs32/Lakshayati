...
You can also download Lakshayati.java to have an interpreter on your computer. In addition to running programs, the latter is capable of opening and saving programs as .txt files. I recommend using a Java IDE like IntelliJ to run it. (I can't get it to work properly with Oracle's newest version of Java for Windows)
