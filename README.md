...
If you like, you can download Lakshayati.java to have an interpreter on your computer. In addition to running programs, the latter is capable of opening and saving programs as .txt files. I recommend compiling the file through an IDE IntelliJ. You can also download the JAR application, but I've had trouble with character encodings that I've only managed to solve with IntelliJ.
